...
* under the License.
*/
package org.wso2.carbon.connector.integration.test.snowflake;
 ...
 */
public class snowflakeConnectorIntegrationTest extends ConnectorIntegrationTestBase {
    ...
    @Test(enabled = true, groups = {"wso2.ei"}, description = "snowflake test case")
